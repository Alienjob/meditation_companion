...
import 'ambient_sounds_panel.dart';

class AmbientSoundsBottomSheetWidget extends StatelessWidget {
  const AmbientSoundsBottomSheetWidget({super.key});
      ...
      builder: (context, scrollController) => Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: AmbientSoundsPanel(scrollController: scrollController),
            ),
          ],
        ),
      ),
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) => MultiRepositoryProvider(
        ...
        child: BlocProvider<MeditationBloc>.value(
          ...
          child: const AmbientSoundsBottomSheetWidget(),
        ),
      ),
    );
  }
